...
package com.my.ctech.powersalespro.PDF_WORK;
...
import com.my.ctech.powersalespro.Date_Base.Contracts;
import com.my.ctech.powersalespro.Date_Base.DbHelper;
import com.my.ctech.powersalespro.R;
...
public class PDF_Templet extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.btn_generate) {
            if (boolean_save) {
                //open pdf file
                File file = new File("/sdcard/PowerSalesPro/Reports/Report(" + Date + ").pdf");
...
//        Bitmap bitmap = BitmapFactory.decodeResource(mResources, R.drawable.screenshot);
        ...
        String targetPdf = "/sdcard/PowerSalesPro/Reports/Report("+Date+").pdf";
    ...
    public void setTableLayout(){
        ...
        while (c1.moveToNext()){
            ...
            String spilt_Used[]=Used.split(" ");
            String[] split_Purch = Pur.split(" ");
            String split_Left[]=Left.split(" ");
            one_m.add(Name);
        ...
        for(int check=0;check<=3;check++) {
            if (check == 0) {
                for (int i = 0; i < c1.getCount(); i++) {
                    @SuppressLint("InflateParams") View tableRow = LayoutInflater.from(this).inflate(R.layout.table_item, null, false);
